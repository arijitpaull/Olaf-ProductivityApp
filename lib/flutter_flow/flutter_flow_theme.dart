...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF00E4FF);
  ...
  late Color accent3 = const Color(0x800028FF);
  late Color accent4 = const Color(0xFFA0A0A0);
  late Color success = const Color(0xFF00FF50);
  late Color warning = const Color(0xFFFFF000);
  late Color error = const Color(0xFFFF0003);
  late Color info = const Color(0x80A0A0A0);
}
